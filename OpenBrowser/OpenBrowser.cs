...
namespace OpenBrowser
{
    public partial class OpenBrowser : Form
    {
        ...
        //<add key="ApiUrl" value="http://localhost:5008/HotUpdateSelf/UpdateController"/>
        // <add key="AdminUrl" value="http://localhost:5000/Activity/Index"/>
        string baseUrl = @"http://localhost:5000/Drive/Index?ActivityId=163&IndexId=%index%&activityFormId=1&ActivityTypeId=1&IsEdit=1";
